                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {effectiveStatusFor(order) === "PENDING" ? (
                          <button
                            ...
                            className="rounded-lg border border-red-200 px-2 py-1 text-[11px] font-semibold text-red-700 hover:bg-red-50 disabled:opacity-60"
                          >
                            Reject
                          </button>
                        ) : null}
                        ...
                        {canCustomerReturn(effectiveStatusFor(order)) ? (
                          <button
                            ...
                            disabled={updatingOrderId === order.id}
                            onClick={() =>
                              onUpdateOrder(order.id, { status: "RETURN_REQUESTED" })
                            }
                            className="rounded-lg border border-amber-200 px-2 py-1 text-[11px] font-semibold text-amber-700 hover:bg-amber-50 disabled:opacity-60"
                          >
                            Return request
                          </button>
                        ) : null}
                        ...
                        {effectiveStatusFor(order) === "RETURNED" ? (
                          <button
                            ...
                            disabled={updatingOrderId === order.id}
                            onClick={() =>
                              onUpdateOrder(order.id, { status: "REFUNDED" })
                            }
                            className="rounded-lg border border-slate-200 px-2 py-1 text-[11px] font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-60"
                          >
                            Mark refunded
